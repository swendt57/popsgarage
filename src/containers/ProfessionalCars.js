...
const mainText =
    <React.Fragment>
        <div className="two-column">
            ...
            <h2 className="two-column-head">Hearses, Limousines, Flower Cars & Ambulances</h2>
            <hr className="two-column-head"/>
            ...
            <p>Besides his love of the vehicles produced by the late American independent auto manufacturers, Pop has a thing for limousines and hearses. His first years working in New York City were full of bumps and bruises because of it. As his head kept swiveling to watch another long shiny black limo glide down the block, Pop kept smacking into the skinny poles that hold up street awnings. The vivid picture of a snooty chauffeur in Saratoga Springs, New York, chastising a small boy for daring to touch the padded top of a custom Cadillac limousine, still haunts his dreams.</p>
                ...
                <div style={{display: "inline-block"}}>
                    ...
                    <p style={{textAlign: "center"}}><a href={window.location.origin + '/assets/galleries/professional_bw_gallery/index.html'}><strong>Black and White Gallery</strong></a> &nbsp;&nbsp;&nbsp;&nbsp; <a href={window.location.origin + '/assets/galleries/professional_color_gallery-1/index.html'}><strong>Color Gallery 1</strong></a> &nbsp;&nbsp;&nbsp;&nbsp; <a href={window.location.origin + '/assets/galleries/professional_color_gallery-2/index.html'}><strong>Color Gallery 2</strong></a></p>
                </div>
...
class ProfessionalCars extends React.Component {
    ...
    resize = () => {
        let useTwoColumns = (window.innerWidth >= 1024)

        if (useTwoColumns !== this.state.needsTwoColumns) {
            this.setState({needsTwoColumns: useTwoColumns});
        }
    };
    ...
    render() {
        ...
        return (
            <Story page_heading="The Professional Cars"
                   ...
                   text={mainText}
                   needsTwoColumns={this.state.needsTwoColumns}/>
        )
    }
